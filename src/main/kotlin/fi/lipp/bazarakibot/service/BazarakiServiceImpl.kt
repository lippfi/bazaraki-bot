...
class BazarakiServiceImpl : BazarakiService {
  ...
  private fun convertToLocation(generalLocation: String, districtLocation: String?): Location? {
    return when (generalLocation) {
      ...
      "Limassol district" -> if (districtLocation != null && districtLocation.contains("Limassol")) Location.LIMASSOL else Location.LIMASSOL_DISTRICT
      "Lefkosia (Nicosia) district" -> if (districtLocation != null && districtLocation.contains("Nicosia")) Location.NICOSIA else Location.NICOSIA_DISTRICT
      "Larnaca district" -> if (districtLocation != null && districtLocation.contains("Larnaca")) Location.LARNACA else Location.LARNACA_DISTRICT
      "Famagusta district" -> if (districtLocation != null && districtLocation.contains("Famagusta")) Location.FAMAGUSTA else Location.FAMAGUSTA_DISTRICT
      else -> null
    }
  }
